	...
	// }
	 ...
	 try 
	 {
		 ...
		 if($polaczenie->connect_errno!=0)
			...
			//$kategoria2 = $polaczenie->query("SELECT ID_kategorii FROM kategorie WHERE Nazwa='$kategoria'");
			//$kategoria3 = json_encode($kategoria2);
			
			
			//$rezultat = $polaczenie->query("SELECT ID_ksiazki FROM ksiazki WHERE Wydawnictwo='$wydawnictwo'");
			...
			if($wszystko_OK==true)
			{
			  ...
			  if($polaczenie->query("INSERT INTO ksiazki(`ID_ksiazki`, `Tytul`, `Autor`, `Wydawnictwo`, `Rok_wydania`, `ID_kategorii`, `Opis`) VALUES (NULL, '$tytul', '$autor', '$wydawnictwo', '$rok_wydania', '$id_kategorii',
			  '$opis')"))
			  {
